export interface RunCommandOptions {
  ...
  /** When true, suppress inheriting stdout/stderr; streams are discarded unless handlers consume them. */
...
export const runCommand = async (
  ...
  const child = Bun.spawn({
    ...
    stdout: options.suppressOutput ? "ignore" : "pipe",
    stderr: options.suppressOutput ? "ignore" : "pipe",
  });
