...
validators.anyOf = function validateAnyOf(instance, schema, options, ctx) {
  ...
  if (
    !schema.anyOf.some(
      testSchemaNoThrow.bind(this, instance, options, ctx, function (res) {
...
validators.if = function validateIf(instance, schema, options, ctx) {
  ...
  var ifValid = testSchemaNoThrow.call(
    this,
    instance,
    options,
    ctx,
 ...
 * @return {String|null|ValidatorResult}
 */
validators.contains = function validateContains(
  instance,
  schema,
  options,
  ctx,
 ...
 * @returns {String|null}
 */
var validateMultipleOfOrDivisbleBy = function validateMultipleOfOrDivisbleBy(
  instance,
  schema,
  options,
  ctx,
...
validators.format = function validateFormat(instance, schema, options, ctx) {
  ...
  var result = new ValidatorResult(instance, schema, options, ctx);
  if (
    !result.disableFormat &&
    !helpers.isFormat(instance, schema.format, this)
  ) {
    result.addError({
      name: "format",
